...
"To be mine, you must be #adj2# as #adj.a# #noun#.", "For you, I will be #adj2# as #adj.a# #noun#."],
        ...
        adj2 : "swift strong fit quick fast fierce mysterious".split(" "),
        noun : ["#animal#", "#nature#", "#object#", "#drink#"],
        animal : "baboon bear camel donkey fox horse cow giraffe cat monkey gorilla lion hedgehog lemur toad sardine pigeon squid oyster cuttlefish".split(" "),
        nature : "cloud island rock mountain hill lake valley river whirlpool plant cactus flower tree forest".split(" "),
        object : "chair table bathtub cupboard wall sofa door cushion bottle curtain kettle".split(" "),
        drink : ["kopi-O", "teh tarik", "cup of chamomile tea", "glass of wine", "shot of vodka", "cup of Milo", "cup of bubble tea"],
    }
}
